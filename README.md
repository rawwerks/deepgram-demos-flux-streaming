...
- Thresholds are tuned for fast start/ slower stop (positive=0.35, negative=0.25, minSpeech=120 ms); adjust these in `index.html` if your environment needs different sensitivity.
